...
In ideal situation that all peers are truechimers, and the reference clocks that
...
Algorithm~\ref{alg:intersection_interval} shows how to get the intersection interval.
In the algorithm,
