...
% this line below allows me use of function like [right=of a] and
% calculation and other stuffs 
% Added by Hanjie Li
\usetikzlibrary{positioning,calc,arrows,fit,matrix}
%\usepackage{pgffor}

% This allows me to use upgreek letter package to get the Greek letter \uptau
% Added by Hanjie Li
\usepackage{upgreek}

% this line below allows me use of environment like \begin{myverbbox}
