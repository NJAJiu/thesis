...
\begin{tikzpicture}[scale=0.7, transform shape,
    ...
    \draw[-latex, ultra thick] (s2) -- (rc);
    \draw[-latex, ultra thick] (s3) -- (s1);
    \draw[-latex, ultra thick] (s3) -- (s2);
    \draw[-latex, ultra thick] (s4) -- (s2);
    \draw[-latex, ultra thick] (client) -- (s2);
    \draw[-latex, ultra thick] (client) -- (s3);
    \draw[-latex, ultra thick] (client) -- (s4);
